...
\newleipzig{f}{fem}{feminine (\S\ref{wordclasses-thegendersystem}, \S\ref{gendersubsec})}           		%feminine
...
\newleipzig{first}{\liningnums{1}}{first person (\S\ref{personsection})}%
\newleipzig{second}{\liningnums{2}}{second person (\S\ref{personsection})}%
\newleipzig{third}{\liningnums{3}}{third person (\S\ref{personsection})}%
