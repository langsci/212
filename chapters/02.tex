...
\tabref{consinv} gives an overview of the consonant phonemes in Komnzo. Graphemes are given in < >.
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item The \isi{epenthetic vowel} is [ŭ] and [ı̆] if followed by heterosyllabic /w/ and /j/, respectively. In all other instances it is [ə̆].
	\end{enumerate}
\end{enumerate}
