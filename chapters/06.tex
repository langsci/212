...
The five \isi{prefix series} \Alph, \Bet, \Betaone, \Betatwo, \Gam{} were briefly addressed in \S{}\ref{personprefsection}. The table from page \pageref{perspref} is reproduced here as \tabref{perspref2}.
...
\begin{exe}
	...
	~ ~ {\Stsg:\Sbj>\Fsg:\Obj:\Nonpast:\Ipfv:\Venit/bother}\\
...
\begin{exe}
	...
	~ ~ ~ {\Stpl:\Sbj>\Fsg:\Io:\Pst:\Ipfv/dance} ~\\
...
\begin{exe}
	...
	~ ~ {\Immpst=\Fsg:\Sbj:\Nonpast:\Ipfv/tell} ~ ~ ~ ~ ~ ~ ~ {\Stsg:\Sbj:\Pst:\Ipfv:\Venit/pass} ~\\
...
\begin{exe}
	...
	~ ~ ~ {\Immpst=\Stpl:\Sbj>\Stpl:\Obj:\Nonpast:\Dur/hold} ~ ~ ~ ~ ~ {\Ssg:\Sbj:\Futimp:\Ipfv/be}\\
...
\begin{exe}
	\ex \emph{watik, fthé \textbf{kranbrigwrth} keke kwa zba we{\fixgll} \textbf{krämätroth}.}\\
	\glll watik fthé k-ra-n-brig-wr-th keke kwa zba we{\fixgll} k-rä-mätr-o-th\\
	then when \M.\Bet-\Irr.\Vc-\Venit-return.\Ext-\Ndu-\Stnsg{} \Neg{} \Fut{} \Prox.\Abl{} also \M.\Bet-\Irr.\Vc.\Ndu-exit.\Rs-\Andat-\Stnsg{}\\
	~ ~ {\Stpl:\Sbj:\Irr:\Ipfv:\Venit/return} ~ ~ ~ ~ {\Stpl:\Sbj:\Irr:\Pfv:\Andat/exit}\\
...
\begin{exe}
	...
	~ {\Spl:\Sbj:\Imp:\Pfv/drink} ~ ~ ~ {\Fsg:\Sbj:\Nonpast:\Ipfv/be}\\
...
\begin{exe}
	...
	~ ~ {\Tsg.\F:\Sbj:\Nonpast:\Ipfv/be} ~ ~ {\Fsg:\Sbj>\Ssg:\Io:\Irr:\Pfv/whisper}\\
	\sn
	\gll bun\\
	\Ssg.\Dat\\
...
\begin{exe}
	...
	~ ~ ~ {\Fdu:\Sbj:\Rpst:\Pfv/sit} ~ {\Ssg:\Sbj:\Rpst:\Pfv/arrive}\\
...
\begin{exe}
	...
	~ ~ ~ {\Fsg:\Sbj>\Stpl:\Obj:\Irr:\Pfv/start}\\
...
\begin{exe}
	...
	~ ~ ~ ~ {\Stdu:\Sbj>\Tsg.\Masc:\Obj:\Pst:\Ipfv/speak}\\
...
\begin{exe}
	...
	\footnotesize{\Stdu:\Sbj>\Fsg:\Obj:\Pst:\Pfv/speak} ~ ~ ~ {\Ssg.\Sbj:\Imp:\Pfv/enter} ~ {\Ssg.\Sbj:\Imp:\Pfv/throw}\\
...
\begin{exe}
	...
	~ ~ ~ ~ {\Stpl:\Sbj>\Tsg:\Obj:\Pst:\Iter:\Dur/call} ~\\
...
\begin{exe}
	...
	\footnotesize{\Stpl:\Sbj:\Pst:\Dur/paddle} ~ {\Prox=\Stpl:\Sbj:\Nonpast:\Ipfv/be}\\
...
\begin{exe}
	...
	\glll ni miyamr mä kwa k-rä-bth-\Zero{} mane (.) mrn-en{\fixgll} k-rä-bth-m-o-\Zero{} frthé\\
	\Fnsg{} ignorance where \Fut{} \M.\Bet-\Irr.\Vc.\Ndu-finish.\Rs-\Stsg{} which (.) clan-\Loc{} \M.\Bet-\Irr.\Vc.\Ndu-finish.\Rs-\Dur-\Andat-\Sg{} when\\
	~ ~ ~ ~ {\Stsg:\Sbj:\Irr:\Pfv/finish} ~ ~ ~ {\Sg:\Sbj:\Irr:\Pfv:\Bg:\Andat/finish} ~\\
...
\begin{exe}
	...
	~ ~ ~ ~ {\Stpl:\Sbj>\Tsg.\Masc:\Obj:\Irr:\Ipfv:\Bg/eat}\\
	\sn
	\gll (.) nagayé\\
	(.) children\\
...
\begin{exe}
	...
	~ ~ {\Ssg:\Sbj>\Stpl:\Obj:\Futimp:\Pfv/send} ~\\
...
\begin{exe}
	...
	~ {\Prox=\Ssg:\Sbj:\Nonpast:\Ipfv/be} ~ {\Ssg:\Sbj:\Imp:\Ipfv/sit} ~ ~ ~ {\Fsg:\Sbj:\Irr:\Pfv:\Venit/return}\\
...
\begin{exe}
	...
	(.) night hunting=\Purp{} who \Stnsg.\Alph-walk.\Ext.\Ndu{} thought=\Assoc=\Etc{}{\fixgll} \Stnsg.\Bet-walk.\Ext.\Ndu-\Imp\\
	~ ~ ~ ~ {\Stpl:\Sbj:\Nonpast:\Ipfv/walk} ~ {\Stpl:\Sbj:\Imp:\Ipfv/walk}\\
...
\begin{exe}
	...
	~ ~ {\Fsg:\Sbj>\Ssg:\Obj:\Irr:\Pfv:\Venit/fetch} ~ ~\\
	\sn
...
\begin{exe}
	...
	~ {\Stdu:\Sbj>\Tsg.\F:\Obj:\Pst:\Dur/do} ~ ~ ~ ~ ~ ~ ~ {\Stpl:\Sbj:\Nonpast:\Ipfv/be}\\
...
\begin{exe}
	...
	~ ~ ~ {\Fsg:\Sbj>\Tsg.\F:\Obj:\Rpst:\Pfv/burn.down} ~ ~\\
	\sn
...
\begin{exe}
	...
	~ {\Stsg:\Sbj>\Tsg.\F:\Obj:\Nonpast:\Ipfv/carry} ~ ~ ~\\
	\sn
	\glll k-a-naf-r-é\\
...
\begin{exe}
	...
	~ ~ ~ {\Tsg.\F:\Sbj:\Irr:\Ipfv/look} ~ ~ ~ ~ ~ {\Immpst=\Fpl:\Sbj>\Tsg.\F:\Obj:\Nonpast:\Dur/put.down.straight}\\
...
\begin{exe}
	...
	~ ~ {\Fsg:\Sbj>\Ssg:\Io:\Nonpast:\Ipfv/tell} ~ ~ ~\\
...
\begin{exe}
	...
	~ ~ ~ {\Tsg.\F:\Sbj:\Irr:\Ipfv/be} ~ ~ ~ ~ ~ ~ ~ ~ ~ {\Fpl:\Sbj>\Tsg.\F:\Obj:\Rpst:\Pfv/see} ~\\
...
\begin{xlist}
	...
	~ ~ {\Stsg:\Sbj>\Tsg.\Masc:\Obj:\Nonpast:\Pfv/show}\\
...
\begin{exe}
	...
	~ ~ ~ {\Stpl:\Sbj:\Nonpast:\Ipfv:\Andat/sit} ~\\
	\sn
	\glll w-a-n-riz-r-th\\
...
\begin{exe}
	...
	\footnotesize{\Fsg:\Sbj:\Rpst:\Ipfv:\Venit/walk} ~ ~ {\Fsg:\Sbj:\Rpst:\Pfv:\Venit/arrive} ~\\
...
\begin{exe}
	...
	~ ~ {\Tsg.\Masc:\Sbj:\Pst:\Dur/be.on.top} ~\\
	\sn
...
\begin{exe}
	...
	~ ~ ~ ~ ~ {\Stsg:\Sbj>\Fsg:\Obj:\Rpst:\Ipfv/disturb} ~ ~ ~ {\Immpst=\Fsg:\Sbj>\Stsg.\Masc:\Obj:\Nonpast:\Ipfv/submerge} ~ ~ ~ ~ ~ ~ ~ {\Stsg:\Sbj:\Rpst:\Pfv:\Venit/run}\\
...
\begin{exe}
	...
	yesterday \Fsg.\Abs{} \Med.\Abl{} \M.\Gam-\Vc.\Ndu-\Venit-set.off.\Ext-\Fsg{} (.) kanathr\\
 	~ ~ ~ {\Fsg:\Sbj:\Rpst:\Pfv:\Venit/set.off} ~ ~\\
...
\begin{exe}
	...
	\footnotesize{\Fdu:\Sbj:\Pst:\Ipfv/walk} ~ ~ {\Tsg.\F:\Sbj:\Nonpast:\Ipfv/be} ~ ~ ~ ~ ~ {\Fdu:\Sbj:\Irr:\Pfv/sit} ~ {\Fdu:\Sbj>\Stpl:\Obj:\Nonpast:\Ipfv/roll}\\
	\sn
	...
	\footnotesize{\Fdu:\Sbj>\Stpl:\Obj:\Nonpast:\Ipfv/eat} ~ {\Fdu:\Sbj:\Irr:\Pfv/set.off} ~ ~ {\Fdu:\Sbj:\Pst:\Dur/walk}\\
...
\begin{exe}
	...
	~ ~ ~ ~ ~ {\Stpl:\Sbj:\Pst:\Pfv/arrive} ~ ~ ~ ~ ~ {\Stpl:\Sbj>\Stpl:\Obj:\Pst:\Ipfv/hit}\\
...
\begin{xlist}
	...
	~ {\Fsg:\Sbj>\Tsg.\Masc:\Obj:\Imp:\Pfv/hit} ~ ~ ~ ~ ~ ~ ~ ~ {\Tsg.\Masc:\Sbj:\Irr:\Ipfv/shout}\\
	...
	~ ~ {\Ssg:\Sbj>\Tsg.\Masc:\Obj:\Imp:\Ipfv/hold}\\
	\sn
	\glll b=\stem{yé} nima s-fsg-w-é (.){\fixgll} s-mitwa-nz-é (.) fi kwa\\
	\Med=\Tsg.\Masc.\Cop.\Ndu{} like.this \Tsg.\Masc.\Bet-blow.\Ext-\Ndu-\Ssg.\Imp{} (.) \Tsg.\Masc.\Bet-swing.\Ext-\Ndu-\Ssg.\Imp{} (.) \Third.\Abs{} \Fut{}\\
	\footnotesize{\Med=\Tsg.\Masc:\Sbj:\Nonpast:\Ipfv/be} ~ {\Ssg:\Sbj>\Tsg.\Masc:\Obj:\Imp:\Ipfv/blow} ~ {\Ssg:\Sbj>\Tsg.\Masc:\Obj:\Imp:\Ipfv/swing} ~ ~ ~\\
	\sn
	\glll y-a-nor\\
...
\begin{exe}
	...
	~ ~ {\Immpst=\Tsg.\Masc:\Sbj:\Nonpast:\Dur/sit} ~ ~\\
	\sn
	\glll th-rä-kwr-th\\
...
\begin{exe}
	...
	~ ~ {\Fsg:\Sbj>\Tsg:\Obj:\Irr:\Pfv/make} ~ ~ ~ {\Tsg.\Masc:\Sbj:\Nonpast:\Ipfv/be}\\
...
\begin{exe}
	...
	\Stnsg.\Bet-\Irr-smash.\Ext-\Ndu-\Stnsg{} (.) liquid \Dem{} which \Stnsg.\Alph-\Cop.\Ndu{}{\fixgll} \Stnsg.\Bet-\Irr.\Ndu-start.\Rs-\Stnsg{} (.) \Tsg.\F.\Bet-\Irr-\Venit-squeeze.\Ext-\Ndu-\Stnsg{} \Emph{} water \Tsg.\F.\Bet-\Irr.\Vc-do.\Ext-\Ndu-\Stnsg{} (.)\\
	\footnotesize{\Stpl:\Sbj>\Stpl:\Obj:\Irr:\Ipfv/smash} ~ ~ ~ ~ {\Stpl:\Sbj:\Nonpast:\Ipfv/be} \footnotesize{\Stpl:\Sbj>\Stpl:\Obj:\Irr:\Pfv/start} ~  \footnotesize{\Stpl:\Sbj>\Tsg.\F:\Obj:\Irr:\Ipfv/squeeze} ~ ~ {\Stpl:\Sbj>\Tsg.\F:\Io:\Irr:\Ipfv/start} ~\\
	\sn
...
\begin{exe}
	...
	\footnotesize{\Fsg:\Sbj:\Irr:\Pfv/fall.asleep} ~ ~ {\Fsg:\Sbj:\Pst:\Dur/sleep} ~ ~ ~ {\Fsg:\Sbj:\Irr:\Pfv/wake.up}\\
