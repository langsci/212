...
\exi{20}
	...
	\gll mnz=en thwa\stem{rakthk}wramo (.) mni tnz-tnz \stem{rä} (.) kwan\stem{brig}wrm nafaneme=wä mnz=fo\\
...
\exi{32}
	...
	\gll fi zä\stem{r}a yak=me we senis zä\stem{r}a (.) kabe woku=thé zä\stem{kor}a nima kabe\\
...
\exi{36}
	...
	\gll kabe matak e\stem{rä} nima z bramöwä kwa\stem{fark}wrth nima e\stem{rä} ŋars=fo\\
