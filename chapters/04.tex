...
\label{caseoverview}
	...
	\begin{tabular}{|l|l|p{2cm}|l|p{2,6cm}|p{2,7cm}|}
		...
		\parbox[t]{4mm}{\multirow{20}{*}{\rotatebox[origin=l]{90}{\hspace{0,5cm}\textsc{semantic cases}}}}&\multirow{3}{*}{\rotatebox[origin=l]{90}{\textsc{spatial}\hspace{0,1cm}}}&\textsc{locative}&&Location	&Simultaneity\\\cline{3-6}
		&&\textsc{allative}&&Goal of motion&\\\cline{3-6}
		&&\textsc{ablative}&&Source of motion&\\\hhline{|~=====|}
		&\multirow{3}{*}{\rotatebox[origin=l]{90}{\textsc{temporal}\hspace{0,5cm}}}&\textsc{\isi{temporal} locative}&&Location in time&\\\cline{3-6}
		&&\textsc{\isi{temporal} purposive}&&Goal in time&\\\cline{3-6}
		&&\textsc{\isi{temporal} possessive}&Origin&Origin&\\\hhline{|~=====|}
		&\multirow{9}{*}{\rotatebox[origin=l]{90}{\textsc{other}}}&\textsc{instrumental}&&Instrument, Manner&Result, Manner\\\cline{3-6}
		&&\textsc{purposive}&&Purpose&Purpose\\\cline{3-6}
		&&\textsc{characteristic}&Origin&Source, Reason, Purpose&Reason, Purpose\\\cline{3-6}
		&&\textsc{proprietive}&&Association&Association, Manner\\\cline{3-6}
		&&\textsc{privative}&&Absence&\\\cline{3-6}
		&&\textsc{associative}&&Association, Inclusion&Association\\\cline{3-6}
		&&\textsc{similative}&&Comparison&\\\midrule
		%\lspbottomrule
	\end{tabular}}%\quad
