...
\small
	\begin{tabular}{|llllll|}
		\hline 
		{({determiner})}&\multicolumn{3}{|c|}{{({premodifier})}}&\multicolumn{1}{c|}{{({head})}}&{({postmodifier})} \rule{0pt}{4mm}\\		
		\hline
		{demonstrative}&\multicolumn{1}{|l}{{numeral}}&{adjectives}&&\multicolumn{1}{|l|}{{{pers} \isi{pronoun}\textsuperscript{b}}}&{{determiner}\textsuperscript{c}}\rule{0pt}{3mm}\\
		{indefinite}&\multicolumn{1}{|l}{{quantifier}}&{property noun}&&\multicolumn{1}{|l|}{{\Indf{} \isi{pronoun}\textsuperscript{b}}}&{adjectives\textsuperscript{d}}\\
		{interrogative}&\multicolumn{1}{|l}{\hfill}&&&\multicolumn{1}{|l|}{{\Recog{} \isi{pronoun}\textsuperscript{b}}}&{\isi{locational}\textsuperscript{d}}\\
		{\Poss{} pronoun}&\multicolumn{1}{|l}{\hfill}&&&\multicolumn{1}{|l|}{{noun}}&{quantifier}\\
		{\Char{} {np}}&\multicolumn{1}{|l}{\hfill}&&&\multicolumn{1}{|l|}{{property noun}}&{numeral}\\
		{\Char{} {np}}&\multicolumn{1}{|l}{\hfill}&&&\multicolumn{1}{|l|}{{nominalised verb compound}}&\\
		\hline
	\end{tabular} 
	}\\
\smallskip
...
~~\parbox{\textwidth}{	
  \footnotesize	
  \textsuperscript{a}\,The \isi{noun phrase} must be marked with adnominal case: \Poss{} {np}, \Temp.\Poss{} {np} or \Char{} {np}.\\
  \textsuperscript{b}\,These word classes constitute a whole \isi{noun phrase} and, thus, are rarely modified.\\
