...
\label{kintermstable}\\
		\lsptoprule
		\textsc{komnzo} & \textsc{gloss}&\textsc{relation}\super{a} & \textsc{comment}\\\midrule
		\endfirsthead
		\textsc{komnzo} & \textsc{gloss}&\textsc{relation}\super{a} & \textsc{comment}\\\midrule
		%\endhead
...
\label{lth}
	\begin{tabular}{llp{1,3cm}p{1,3cm}lllp{1,5cm}}
		\lsptoprule
		&\textsc{item} &Blafe, Ránmo &Wartha Thuntai &Kánchá &Wèré &Anta &Komnzo, Wára \\\midrule
...
\label{mbng}
	\begin{tabular}{llp{1,5cm}p{1,5cm}llp{1,5cm}}
		\lsptoprule
		&\textsc{item} &Blafe, Ránmo & Wartha Thuntai & Kánchá& Wèré &Komnzo, Wára, Anta\\\midrule
...
\label{fmb}
 	\begin{tabular}{llp{1,5cm}p{1,5cm}p{1,5cm}p{2cm}}
 		\lsptoprule
 		&\textsc{item}& Blafe, Ránmo & Wartha Thuntai &Kánchá, Komnzo & Wára, Anta, Wèré\\\midrule
...
\label{palatal}
	\begin{tabular}{llp{1,5cm}llll}
		\lsptoprule
			&\textsc{item} & Wartha Thuntai	&Kánchá &Wèré &Komnzo &Nama\\\midrule
