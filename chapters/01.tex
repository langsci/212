...
\begin{table}
\label{consonants}
	\begin{tabularx}{\textwidth}{p{1cm}p{1cm}p{1cm}p{1cm}p{1cm}p{1cm}p{1cm}}
		&&t&ts&&k&k\super{w}\\
...
\begin{tabularx}{\textwidth}{llp{3cm}p{4,7cm}}
\label{kintermstable}\\
		\lsptoprule
...
\label{lth}
	\begin{tabularx}{\textwidth}{Xlp{1,3cm}p{1,3cm}lllp{1,5cm}}
		\lsptoprule
		...
		4 &{armpit} & \super{ŋ}gəlki &\super{ŋ}gəθki &kəθtʃi &\super{ŋ}gəθki &\super{ŋ}gəθtʃi &\super{ŋ}gəθtʃi\\
		\lspbottomrule
	\end{tabularx}
...
\label{mbng}
	\begin{tabularx}{\textwidth}{Xlp{1,5cm}p{1,5cm}llp{1,5cm}}
		\lsptoprule
		&{item} &Blafe, Ránmo & Wartha Thuntai & Kánchá& Wèré &Komnzo, Wára, Anta\\\midrule
		1 &{nest} &\super{m}bəl &\super{m}bəθ &\super{ŋ}g\super{w}əθ	&\super{ŋ}g\super{w}əθ &\super{ŋ}g\super{w}əθ\\
		2 &{mosquito} &\super{m}bæ &\super{m}bæ &\super{ŋ}g\super{w}æ &\super{ŋ}g\super{w}æ &\super{ŋ}g\super{w}æ\\
		3 &{butterfly} &ta\super{m}bam &ta\super{m}buram &\super{m}bæ\super{ŋ}goram &\multicolumn{2}{c}{\super{m}bæ\super{ŋ}g\super{w}ərəm}\\
		4 &{crow} &\super{m}baθ &kot &koθ &koθ &k\super{w}aθ\\
		5 &{light} &praja &bæjan &k\super{w}ajan &k\super{w}ajan &k\super{w}ajan\\
		6 &{sick} &bik &bik &k\super{w}ik &k\super{w}ik &k\super{w}ik\\
		\lspbottomrule
	\end{tabularx}
...
\label{fmb}
 	\begin{tabularx}{\textwidth}{Xlp{1,5cm}p{1,5cm}p{1,5cm}p{2cm}}
 		\lsptoprule
 		&{item}& Blafe, Ránmo & Wartha Thuntai &Kánchá, Komnzo & Wára, Anta, Wèré\\\midrule
 		1 &{wife} &\super{m}bə\super{ŋ}ge\super{n}t &\super{m}bə\super{ŋ}ge\super{n}ts &ɸətʃe\super{n}ts &ɸətʃe\super{n}ts\\
 		2&{husband} &\super{m}bi &\super{m}bi &ɸis &ɸis\\
...
\label{palatal}
	\begin{tabularx}{\textwidth}{Xlp{1,5cm}llll}
		\lsptoprule
			&{item} & Wartha Thuntai	&Kánchá &Wèré &Komnzo &Nama\\\midrule
			1 &{woman}\super{a} &\super{m}broki &\super{m}brotʃi &\super{m}brasi &\super{m}bratʃi &\super{m}brake\\
			2 &\Fsg.\Abs &\super{ŋ}ga &\super{n}dʒæ &se &\super{n}dʒæ &(jə\super{n}d)\\
			3 &{people}\super{b} &\super{ŋ}gʏ\super{n}təm &tʃœ\super{n}təm &sœ\super{n}tmæ &tʃœ\super{n}tmæ &\super{ŋ}gʏ\super{n}tmæ\\
			4 &{house} &me\super{n}k &mə\super{ŋ}k &mə\super{n}ts &mə\super{n}ts &mæ\super{ŋ}go\\
			5 &1 ({one}) &ŋæ\super{m}bi &ŋæ\super{m}bi &næ\super{m}bi &næ\super{m}bi &æ\super{m}biro\\
			6 &{armpit} &\super{ŋ}gəθki &kəθtʃi &\super{ŋ}gəθki &\super{ŋ}gəθtʃi &-\\
			7 &{tree type} &\super{ŋ}gœ\super{n}t &\super{ŋ}gœ\super{n}t &\super{ŋ}go\super{n}t &\super{n}dʒœ\super{n}ts &-\\
		\lspbottomrule
...
\label{affrstop}
	\begin{tabularx}{\textwidth}{Xlp{1,1cm}p{1,3cm}lllp{1,3cm}}
		\lsptoprule
		&{item} &Blafe, Ránmo &Wartha Thuntai &Kánchá &Wèré &Anta &Komnzo, Wára\\\midrule
		1 &{pain} &ti &\super{n}dʒi &tʃi &ti &ti &tʃi\\
		2 &{right} &tawe &tsowe &tsowe &tawe &tawe &tsawe\\
		3 &{bowerbird} &\super{n}dojar &\super{n}dʒojar &\super{n}dʒojar &\super{n}dʒojar &\super{n}dojar &\super{n}dʒœjar\\
		\lspbottomrule
	\end{tabularx}
...
\label{compcase}
 	\begin{tabularx}{\textwidth}{Xlllll}
		\lsptoprule
 		& \ili{Kánchá} &\ili{Wèré} &\ili{Wára} &\ili{Anta} &Komnzo \\\midrule
 		\Erg.\Sg&-o&-o&-o&-o&-ɸ\\
