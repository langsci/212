...
\end{longtable}%The formal relationship between \Ext{} and \Rs{} stem
...
\begin{tabular}{lllll}
	...
	\emph{wäthsi} &\emph{wä-}& \emph{wäth-}	&\emph{wäf-} &be wrapped\\\hline
...
\centering
	\begin{tabular}{|c|c|p{1,5cm}p{1,5cm}|}
		...
		\multicolumn{2}{c|}{}&\multicolumn{1}{c}{\Du}&\multicolumn{1}{|c|}{\Ndu}\\\hline
...
\begin{longtable}[H]{lllll}
	...
	\textsc{total}&&275&&\\
	\lspbottomrule
\end{longtable}%Allomorphs of the \isi{non-dual} suffix
