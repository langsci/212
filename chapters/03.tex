...
As far as the other criteria are concerned, \isi{possessive} constructions are only possible with nouns and property nouns and not with adjectives. The \isi{adjectivaliser} \emph{-thé} is common with particular nouns, optional with property nouns, but ungrammatical with adjectives. The \isi{instrumental} \isi{case} marker \emph{=me} serves its prototypical function with nouns, but property nouns and adjectives function function as adverbials when marked with the \isi{instrumental} \isi{case}. Table \ref{nominals-overview} provides an overview of the criteria.
	...
	\begin{longtable}{lccc}
		...
		\toprule
		\toprule
			&\textsc{nouns}&\textsc{property nouns}&\textsc{adjectives}\\ \hline
			\endfirsthead
			&\textsc{nouns}&\textsc{property nouns}&\textsc{adjectives}\\ \hline
			\endhead
			gender agreement&+&-&-\\
...
\label{wordclasses-gendersem}
	\begin{tabular}	{p{2cm}lp{4,4cm}p{4,1cm}}
		\lsptoprule
		\textsc{semantics}&\textsc{gender}&\textsc{examples}&\textsc{exceptions}\\\hline
		...
		&&\emph{mür} `grass type' (Cyprus sp)&\\\hline
		...
		&&\emph{wifaza} `seven-spot archerfish' (Toxotes chatareus)&\\\hline
...
\label{numerals-table}
	\begin{tabular}{llll}
		\lsptoprule
		\multicolumn{2}{l}{\textsc{value}}&\textsc{restricted}&\textsc{ritualised}\\\hline
...
\label{locationaltable}
	\begin{tabular}{lll}
		\lsptoprule
		\textsc{form}&\textsc{gloss}&\textsc{historical derivation}\\ \hline
...
\label{perspron}\\
	\lsptoprule
	\textsc{case}&\Fsg{}&\Fnsg{}&\Ssg{}&\Snsg{}&\Tsg{}&\Tnsg{}\\ \hline
	\endfirsthead
	\textsc{case}&\Fsg{}&\Fnsg{}&\Ssg{}&\Snsg{}&\Tsg{}&\Tnsg{}\\ \hline
	\endhead
...
\end{longtable}}%Personal pronouns
...
\label{interrog}
	\begin{tabular}{llll}
		\lsptoprule
		\textsc{case} & \textsc{inanimate} & \textsc{animate} \Sg & \textsc{animate} \Nsg\\\hline
...
\label{demonstratives-table}
	\begin{tabular}{llllll}
		\lsptoprule
		&\isi{pronoun}\textsuperscript{a}&adverbial&adv.\All{}&adv.\Abl{}&verb clitic\\ \hline
...
\label{manner-adverbs}
	\begin{tabular}{ll}
		\lsptoprule
		\textsc{komnzo}&\textsc{gloss}\\\hline
		\emph{eräme}&`together'\\
		\emph{kwot}&`properly'\\
		\emph{matar}&`quietly'\\
...
\begin{table}[H]
	...
	\begin{tabular}{ll}
		\lsptoprule
		\multicolumn{2}{l}{\textsc{sounds from nature}}\\ \hline
		...
		%&\\
		\multicolumn{2}{l}{\textsc{animal sounds}}\\ \hline
		...
		%&\\
		\multicolumn{2}{l}{\textsc{bodily sounds}}\\ \hline
		...
		%&\\
		\multicolumn{2}{l}{\textsc{human made noises}}\\ \hline
		...
		%&\\
		\multicolumn{2}{l}{\textsc{human made signal sounds}}\\ \hline
...
\label{interjections}
	\begin{tabular}{lp{9,5cm}}
		\lsptoprule
		\textsc{form}&\textsc{translation (and context)}\\\hline
