...
\exi{29} 
	...
	\gll watik menz-menz ane fof yabun kafar (.) thgathg bäne=mr ane fof zen\stem{far}a (.)\\ 
...
\exi{133} 
	...
	\gll we foba kre\stem{karis} oh farem kar=en kabe \stem{yé}\\ 
...
\exi{142} 
	...
	\gll moba fthmäsü zän\stem{brim}a watik (.) nasi nömä ane fof tnäg-si then\stem{thkäf}a r-rfar (.) futh-futh\\ 
...
\exi{166} 
	...
	\gll fobo ffé n wawa kwa\stem{näbü}nzrmth (.) kwosi kwa\stem{ko}nzrmth bäne=mr e (.) tayo tfotfo\\ 
...
\exi{192} 
	...
	\trans `but nobody follows this today any longer.'\Corpus{tci20131013-01}{}
\end{exe}%kwafar